...
// Create a functional component for the service block
const ServiceBlock: React.FC<{ iconClass: string, title: string, description: string }> = ({ iconClass, title, description }) => (
...
// Create the main functional component for the service blocks
const ServiceBlocks: React.FC = () => (
  <div className="service-blocks">
    ...
    <ServiceBlock
      ...
      description="In-depth insights and analysis to understand market dynamics, competitors, and potential opportunities."
    />

    {/* Marketing Plan Development Block */}
    <ServiceBlock
      iconClass="fas fa-bullseye"
      title="Marketing Plan Development"
      description="Crafting bespoke marketing strategies that align with your startup's goals and objectives."
    />
    ...
    <ServiceBlock
      ...
      title="Branding"
      description="Building memorable brands that resonate with target audiences and differentiate in the market."
    />
    ...
    <ServiceBlock
      ...
      description="Ensuring your startup is visible, accessible, and impactful across all digital platforms."
    />
    ...
    <ServiceBlock
      ...
      description="Engaging content and strategies to boost your brand's presence on social media platforms."
    />
    ...
    <ServiceBlock
      ...
      title="SEO"
      description="Optimizing your online content to enhance visibility on search engines and drive organic traffic."
    />
    ...
    <ServiceBlock
      ...
      title="SEM"
      description="Leveraging paid advertising to increase visibility on search engines and drive targeted traffic."
    />

    {/* Growth Hacking Block */}
    <ServiceBlock
      iconClass="fas fa-rocket"
      title="Growth Hacking"
      description="Innovative strategies designed for rapid growth, maximizing your startup's potential."
    />

    {/* Advanced Marketing Block */}
    <ServiceBlock
      iconClass="fas fa-layer-group"
      title="Advanced Marketing"
      description="Utilizing the latest marketing techniques and tools to ensure your startup stays ahead in the competitive landscape."
    />
  </div>
);
