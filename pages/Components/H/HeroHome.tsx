    ...
    useEffect(() => {
      const swapIcons = () => {
        ...
        icons.forEach(icones => {
          ...
          let size;
          if (icones.classList.contains('solid-circle') || icones.classList.contains('outlined-circle')) {
            ...
            icones.style.width = size;
            icones.style.height = size;
          } else if (icones.classList.contains('square') || icones.classList.contains('outlined-square')) {
